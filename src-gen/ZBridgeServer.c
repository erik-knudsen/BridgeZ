...
static void zBridgeServer_entryaction(ZBridgeServer* handle);
static void zBridgeServer_exitaction(ZBridgeServer* handle);
...
static void zBridgeServer_react_ZBridgeServer_entry___sync3(ZBridgeServer* handle);
static void clearInEvents(ZBridgeServer* handle);
...
{
	{
		...
		zBridgeServer_entryaction(handle);
		{
...
{
	{
		...
		zBridgeServer_exitaction(handle);
	}
}
...
static void zBridgeServer_react_entry__Connect_West_Seated(ZBridgeServer* handle) {
	{
		/* The reactions of state Seated. */
		if (handle->iface.rTNames_value == handle->internal.W && handle->iface.rTNames_raised) { 
			{
				/* Default exit sequence for state Seated */
				handle->stateConfVector[0] = ZBridgeServer_last_state;
				handle->stateConfVectorPosition = 0;
			...
			handle->internal.westRTNames = bool_true;
			{
				/* 'default' enter sequence for state TeamNames */
				{
					...
					if (handle->internal.southRTNames && handle->internal.eastRTNames && handle->internal.northRTNames && handle->internal.westRTNames) { 
...
static void zBridgeServer_react_entry__Connect_West_TeamNames(ZBridgeServer* handle) {
	{
		/* The reactions of state TeamNames. */
		if (handle->iface.rSBoard_value == handle->internal.W && handle->iface.rSBoard_raised) { 
			{
				/* Default exit sequence for state TeamNames */
				handle->stateConfVector[0] = ZBridgeServer_last_state;
				handle->stateConfVectorPosition = 0;
			...
			handle->internal.westRSBoard = bool_true;
			{
				/* 'default' enter sequence for state StartOfBoard */
				{
					...
					if (handle->internal.southRSBoard && handle->internal.eastRSBoard && handle->internal.northRSBoard && handle->internal.westRSBoard) { 
...
static void zBridgeServer_react_entry__Connect_West_StartOfBoard(ZBridgeServer* handle) {
	{
		/* The reactions of state StartOfBoard. */
		if (handle->iface.continue_raised && zBridgeServer_isActive(handle, ZBridgeServer_entry__Connect_South_StartOfBoard) && handle->iface.continue_raised && zBridgeServer_isActive(handle, ZBridgeServer_entry__Connect_East_StartOfBoard) && handle->iface.continue_raised && zBridgeServer_isActive(handle, ZBridgeServer_entry__Connect_North_StartOfBoard) && handle->iface.continue_raised) { 
			{
				/* Default exit sequence for state Connect */
				{
			...
			zBridgeServer_react_ZBridgeServer_entry___sync0(handle);
		} 
	}
}
...
static void zBridgeServer_react_entry__Connect_West_Connect(ZBridgeServer* handle) {
	{
		/* The reactions of state Connect. */
		if (handle->iface.connect_value == handle->internal.W && handle->iface.connect_raised) { 
			{
				/* Default exit sequence for state Connect */
				handle->stateConfVector[0] = ZBridgeServer_last_state;
				handle->stateConfVectorPosition = 0;
...
static void zBridgeServer_react_entry__Connect_North_Seated(ZBridgeServer* handle) {
	{
		/* The reactions of state Seated. */
		if (handle->iface.rTNames_value == handle->internal.N && handle->iface.rTNames_raised) { 
			{
				/* Default exit sequence for state Seated */
				handle->stateConfVector[1] = ZBridgeServer_last_state;
				handle->stateConfVectorPosition = 1;
...
static void zBridgeServer_react_entry__Connect_North_TeamNames(ZBridgeServer* handle) {
	{
		/* The reactions of state TeamNames. */
		if (handle->iface.rSBoard_value == handle->internal.N && handle->iface.rSBoard_raised) { 
			{
				/* Default exit sequence for state TeamNames */
				handle->stateConfVector[1] = ZBridgeServer_last_state;
				handle->stateConfVectorPosition = 1;
...
static void zBridgeServer_react_entry__Connect_North_StartOfBoard(ZBridgeServer* handle) {
	{
		/* The reactions of state StartOfBoard. */
		if (handle->iface.continue_raised && zBridgeServer_isActive(handle, ZBridgeServer_entry__Connect_South_StartOfBoard) && handle->iface.continue_raised && zBridgeServer_isActive(handle, ZBridgeServer_entry__Connect_East_StartOfBoard) && handle->iface.continue_raised && zBridgeServer_isActive(handle, ZBridgeServer_entry__Connect_West_StartOfBoard) && handle->iface.continue_raised) { 
			{
				/* Default exit sequence for state Connect */
				{
					/* Default exit sequence for region West */
...
static void zBridgeServer_react_entry__Connect_North_Connect(ZBridgeServer* handle) {
	{
		/* The reactions of state Connect. */
		if (handle->iface.connect_value == handle->internal.N && handle->iface.connect_raised) { 
			{
				/* Default exit sequence for state Connect */
				handle->stateConfVector[1] = ZBridgeServer_last_state;
				handle->stateConfVectorPosition = 1;
...
static void zBridgeServer_react_entry__Connect_East_Seated(ZBridgeServer* handle) {
	{
		/* The reactions of state Seated. */
		if (handle->iface.rTNames_value == handle->internal.E && handle->iface.rTNames_raised) { 
			{
				/* Default exit sequence for state Seated */
				handle->stateConfVector[2] = ZBridgeServer_last_state;
				handle->stateConfVectorPosition = 2;
...
static void zBridgeServer_react_entry__Connect_East_TeamNames(ZBridgeServer* handle) {
	{
		/* The reactions of state TeamNames. */
		if (handle->iface.rSBoard_value == handle->internal.E && handle->iface.rSBoard_raised) { 
			{
				/* Default exit sequence for state TeamNames */
				handle->stateConfVector[2] = ZBridgeServer_last_state;
				handle->stateConfVectorPosition = 2;
...
static void zBridgeServer_react_entry__Connect_East_StartOfBoard(ZBridgeServer* handle) {
	{
		/* The reactions of state StartOfBoard. */
		if (handle->iface.continue_raised && zBridgeServer_isActive(handle, ZBridgeServer_entry__Connect_South_StartOfBoard) && handle->iface.continue_raised && zBridgeServer_isActive(handle, ZBridgeServer_entry__Connect_North_StartOfBoard) && handle->iface.continue_raised && zBridgeServer_isActive(handle, ZBridgeServer_entry__Connect_West_StartOfBoard) && handle->iface.continue_raised) { 
			{
				/* Default exit sequence for state Connect */
				{
					/* Default exit sequence for region West */
...
static void zBridgeServer_react_entry__Connect_East_Connect(ZBridgeServer* handle) {
	{
		/* The reactions of state Connect. */
		if (handle->iface.connect_value == handle->internal.E && handle->iface.connect_raised) { 
			{
				/* Default exit sequence for state Connect */
				handle->stateConfVector[2] = ZBridgeServer_last_state;
				handle->stateConfVectorPosition = 2;
...
static void zBridgeServer_react_entry__Connect_South_Seated(ZBridgeServer* handle) {
	{
		/* The reactions of state Seated. */
		if (handle->iface.rTNames_value == handle->internal.S && handle->iface.rTNames_raised) { 
			{
				/* Default exit sequence for state Seated */
				handle->stateConfVector[3] = ZBridgeServer_last_state;
				handle->stateConfVectorPosition = 3;
...
static void zBridgeServer_react_entry__Connect_South_TeamNames(ZBridgeServer* handle) {
	{
		/* The reactions of state TeamNames. */
		if (handle->iface.rSBoard_value == handle->internal.S && handle->iface.rSBoard_raised) { 
			{
				/* Default exit sequence for state TeamNames */
				handle->stateConfVector[3] = ZBridgeServer_last_state;
				handle->stateConfVectorPosition = 3;
...
static void zBridgeServer_react_entry__Connect_South_StartOfBoard(ZBridgeServer* handle) {
	{
		/* The reactions of state StartOfBoard. */
		if (handle->iface.continue_raised && zBridgeServer_isActive(handle, ZBridgeServer_entry__Connect_East_StartOfBoard) && handle->iface.continue_raised && zBridgeServer_isActive(handle, ZBridgeServer_entry__Connect_North_StartOfBoard) && handle->iface.continue_raised && zBridgeServer_isActive(handle, ZBridgeServer_entry__Connect_West_StartOfBoard) && handle->iface.continue_raised) { 
			{
				/* Default exit sequence for state Connect */
				{
					/* Default exit sequence for region West */
...
static void zBridgeServer_react_entry__Connect_South_Connect(ZBridgeServer* handle) {
	{
		/* The reactions of state Connect. */
		if (handle->iface.connect_value == handle->internal.S && handle->iface.connect_raised) { 
			{
				/* Default exit sequence for state Connect */
				handle->stateConfVector[3] = ZBridgeServer_last_state;
				handle->stateConfVectorPosition = 3;
...
static void zBridgeServer_react_entry__Deal_North_Info(ZBridgeServer* handle) {
	{
		/* The reactions of state Info. */
		if (handle->iface.rDealInfo_value == handle->internal.N && handle->iface.rDealInfo_raised) { 
			{
				/* Default exit sequence for state Info */
				handle->stateConfVector[1] = ZBridgeServer_last_state;
				handle->stateConfVectorPosition = 1;
...
static void zBridgeServer_react_entry__Deal_North_Cards(ZBridgeServer* handle) {
	{
		/* The reactions of state Cards. */
		if (handle->iface.rCards_value == handle->internal.N && handle->iface.rCards_raised) { 
			{
				/* Default exit sequence for state Cards */
				handle->stateConfVector[1] = ZBridgeServer_last_state;
				handle->stateConfVectorPosition = 1;
...
static void zBridgeServer_react_entry__Deal_North_Sync(ZBridgeServer* handle) {
	{
		/* The reactions of state Sync. */
		if (handle->iface.continue_raised && zBridgeServer_isActive(handle, ZBridgeServer_entry__Deal_South_Sync) && handle->iface.continue_raised && zBridgeServer_isActive(handle, ZBridgeServer_entry__Deal_East_Sync) && handle->iface.continue_raised && zBridgeServer_isActive(handle, ZBridgeServer_entry__Deal_West_Sync) && handle->iface.continue_raised) { 
			{
				/* Default exit sequence for state Deal */
				{
					/* Default exit sequence for region West */
...
static void zBridgeServer_react_entry__Deal_East_Info(ZBridgeServer* handle) {
	{
		/* The reactions of state Info. */
		if (handle->iface.rDealInfo_value == handle->internal.E && handle->iface.rDealInfo_raised) { 
			{
				/* Default exit sequence for state Info */
				handle->stateConfVector[2] = ZBridgeServer_last_state;
				handle->stateConfVectorPosition = 2;
...
static void zBridgeServer_react_entry__Deal_East_Cards(ZBridgeServer* handle) {
	{
		/* The reactions of state Cards. */
		if (handle->iface.rCards_value == handle->internal.E && handle->iface.rCards_raised) { 
			{
				/* Default exit sequence for state Cards */
				handle->stateConfVector[2] = ZBridgeServer_last_state;
				handle->stateConfVectorPosition = 2;
...
static void zBridgeServer_react_entry__Deal_East_Sync(ZBridgeServer* handle) {
	{
		/* The reactions of state Sync. */
		if (handle->iface.continue_raised && zBridgeServer_isActive(handle, ZBridgeServer_entry__Deal_South_Sync) && handle->iface.continue_raised && zBridgeServer_isActive(handle, ZBridgeServer_entry__Deal_North_Sync) && handle->iface.continue_raised && zBridgeServer_isActive(handle, ZBridgeServer_entry__Deal_West_Sync) && handle->iface.continue_raised) { 
			{
				/* Default exit sequence for state Deal */
				{
					/* Default exit sequence for region West */
...
static void zBridgeServer_react_entry__Deal_South_Info(ZBridgeServer* handle) {
	{
		/* The reactions of state Info. */
		if (handle->iface.rDealInfo_value == handle->internal.S && handle->iface.rDealInfo_raised) { 
			{
				/* Default exit sequence for state Info */
				handle->stateConfVector[3] = ZBridgeServer_last_state;
				handle->stateConfVectorPosition = 3;
...
static void zBridgeServer_react_entry__Deal_South_Cards(ZBridgeServer* handle) {
	{
		/* The reactions of state Cards. */
		if (handle->iface.rCards_value == handle->internal.S && handle->iface.rCards_raised) { 
			{
				/* Default exit sequence for state Cards */
				handle->stateConfVector[3] = ZBridgeServer_last_state;
				handle->stateConfVectorPosition = 3;
...
static void zBridgeServer_react_entry__Deal_South_Sync(ZBridgeServer* handle) {
	{
		/* The reactions of state Sync. */
		if (handle->iface.continue_raised && zBridgeServer_isActive(handle, ZBridgeServer_entry__Deal_East_Sync) && handle->iface.continue_raised && zBridgeServer_isActive(handle, ZBridgeServer_entry__Deal_North_Sync) && handle->iface.continue_raised && zBridgeServer_isActive(handle, ZBridgeServer_entry__Deal_West_Sync) && handle->iface.continue_raised) { 
			{
				/* Default exit sequence for state Deal */
				{
					/* Default exit sequence for region West */
			...
			if (handle->iface.undo_value == - 1 && handle->iface.undo_raised) { 
				...
				if (handle->iface.newDeal_raised) { 
					...
					if (handle->iface.newSession_raised) { 
						...
						if (handle->iface.bid_value == handle->internal.W && handle->iface.bid_raised) { 
							{
								/* Default exit sequence for state Wait */
								handle->stateConfVector[0] = ZBridgeServer_last_state;
								handle->stateConfVectorPosition = 0;
							...
							}
							{
								...
								{
									/* Entry action for state 'Sync'. */
									if (handle->internal.southBid && handle->internal.eastBid && handle->internal.northBid && handle->internal.westBid) { 
							...
							if (handle->iface.rBid_value == handle->internal.W && handle->iface.rBid_raised) { 
								{
									/* Default exit sequence for state Wait */
									handle->stateConfVector[0] = ZBridgeServer_last_state;
									handle->stateConfVectorPosition = 0;
			...
			if (handle->iface.undo_value == - 1 && handle->iface.undo_raised) { 
				...
				if (handle->iface.newDeal_raised) { 
					...
					if (handle->iface.newSession_raised) { 
						...
						if (handle->iface.continue_raised && zBridgeServer_isActive(handle, ZBridgeServer_entry__Bidding_South_Sync) && handle->iface.continue_raised && zBridgeServer_isActive(handle, ZBridgeServer_entry__Bidding_East_Sync) && handle->iface.continue_raised && zBridgeServer_isActive(handle, ZBridgeServer_entry__Bidding_North_Sync) && handle->iface.continue_raised) { 
							{
								/* Default exit sequence for state Bidding */
								{
									/* Default exit sequence for region West */
							...
							zBridgeServer_react_ZBridgeServer_entry___sync2(handle);
						} 
					}
				}
			}
...
static void zBridgeServer_react_entry__Bidding_North_Wait(ZBridgeServer* handle) {
	{
		/* The reactions of state Wait. */
		if (handle->iface.rBid_value == handle->internal.N && handle->iface.rBid_raised) { 
			{
				/* Default exit sequence for state Wait */
				handle->stateConfVector[1] = ZBridgeServer_last_state;
				handle->stateConfVectorPosition = 1;
			...
			if (handle->iface.bid_value == handle->internal.N && handle->iface.bid_raised) { 
				{
					/* Default exit sequence for state Wait */
					handle->stateConfVector[1] = ZBridgeServer_last_state;
					handle->stateConfVectorPosition = 1;
...
static void zBridgeServer_react_entry__Bidding_North_Sync(ZBridgeServer* handle) {
	{
		/* The reactions of state Sync. */
		if (handle->iface.continue_raised && zBridgeServer_isActive(handle, ZBridgeServer_entry__Bidding_South_Sync) && handle->iface.continue_raised && zBridgeServer_isActive(handle, ZBridgeServer_entry__Bidding_East_Sync) && handle->iface.continue_raised && zBridgeServer_isActive(handle, ZBridgeServer_entry__Bidding_West_Sync) && handle->iface.continue_raised) { 
			{
				/* Default exit sequence for state Bidding */
				{
					/* Default exit sequence for region West */
...
static void zBridgeServer_react_entry__Bidding_East_Wait(ZBridgeServer* handle) {
	{
		/* The reactions of state Wait. */
		if (handle->iface.rBid_value == handle->internal.E && handle->iface.rBid_raised) { 
			{
				/* Default exit sequence for state Wait */
				handle->stateConfVector[2] = ZBridgeServer_last_state;
				handle->stateConfVectorPosition = 2;
			...
			if (handle->iface.bid_value == handle->internal.E && handle->iface.bid_raised) { 
				{
					/* Default exit sequence for state Wait */
					handle->stateConfVector[2] = ZBridgeServer_last_state;
					handle->stateConfVectorPosition = 2;
...
static void zBridgeServer_react_entry__Bidding_East_Sync(ZBridgeServer* handle) {
	{
		/* The reactions of state Sync. */
		if (handle->iface.continue_raised && zBridgeServer_isActive(handle, ZBridgeServer_entry__Bidding_South_Sync) && handle->iface.continue_raised && zBridgeServer_isActive(handle, ZBridgeServer_entry__Bidding_North_Sync) && handle->iface.continue_raised && zBridgeServer_isActive(handle, ZBridgeServer_entry__Bidding_West_Sync) && handle->iface.continue_raised) { 
			{
				/* Default exit sequence for state Bidding */
				{
					/* Default exit sequence for region West */
...
static void zBridgeServer_react_entry__Bidding_South_Wait(ZBridgeServer* handle) {
	{
		/* The reactions of state Wait. */
		if (handle->iface.rBid_value == handle->internal.S && handle->iface.rBid_raised) { 
			{
				/* Default exit sequence for state Wait */
				handle->stateConfVector[3] = ZBridgeServer_last_state;
				handle->stateConfVectorPosition = 3;
			...
			if (handle->iface.bid_value == handle->internal.S && handle->iface.bid_raised) { 
				{
					/* Default exit sequence for state Wait */
					handle->stateConfVector[3] = ZBridgeServer_last_state;
					handle->stateConfVectorPosition = 3;
...
static void zBridgeServer_react_entry__Bidding_South_Sync(ZBridgeServer* handle) {
	{
		/* The reactions of state Sync. */
		if (handle->iface.continue_raised && zBridgeServer_isActive(handle, ZBridgeServer_entry__Bidding_East_Sync) && handle->iface.continue_raised && zBridgeServer_isActive(handle, ZBridgeServer_entry__Bidding_North_Sync) && handle->iface.continue_raised && zBridgeServer_isActive(handle, ZBridgeServer_entry__Bidding_West_Sync) && handle->iface.continue_raised) { 
			{
				/* Default exit sequence for state Bidding */
				{
					/* Default exit sequence for region West */
			...
			if (handle->iface.undo_value == - 1 && handle->iface.undo_raised) { 
				...
				if (handle->iface.newDeal_raised) { 
					...
					if (handle->iface.newSession_raised) { 
						...
						if (handle->iface.playerPlays_value == handle->internal.W && handle->iface.playerPlays_raised) { 
							{
								/* Default exit sequence for state Wait */
								handle->stateConfVector[0] = ZBridgeServer_last_state;
								handle->stateConfVectorPosition = 0;
							...
							}
							{
								...
								{
									/* Entry action for state 'Sync'. */
									if (handle->internal.southRCard && handle->internal.eastRCard && handle->internal.northRCard && handle->internal.westRCard) { 
							...
							if ((handle->iface.readyForPlayer_value == handle->internal.W) && handle->iface.readyForPlayer_raised) { 
								{
									/* Default exit sequence for state Wait */
									handle->stateConfVector[0] = ZBridgeServer_last_state;
									handle->stateConfVectorPosition = 0;
								...
								if (handle->iface.readyForDummy_value == handle->internal.W && handle->iface.readyForDummy_raised) { 
									{
										/* Default exit sequence for state Wait */
										handle->stateConfVector[0] = ZBridgeServer_last_state;
										handle->stateConfVectorPosition = 0;
									...
									if (handle->iface.readyForDummyCards_value == handle->internal.W && handle->iface.readyForDummyCards_raised) { 
										{
											/* Default exit sequence for state Wait */
											handle->stateConfVector[0] = ZBridgeServer_last_state;
											handle->stateConfVectorPosition = 0;
			...
			if (handle->iface.undo_value == - 1 && handle->iface.undo_raised) { 
				...
				if (handle->iface.newDeal_raised) { 
					...
					if (handle->iface.newSession_raised) { 
						...
						if (handle->iface.continue_raised && zBridgeServer_isActive(handle, ZBridgeServer_entry__Playing_South_Sync) && handle->iface.continue_raised && zBridgeServer_isActive(handle, ZBridgeServer_entry__Playing_East_Sync) && handle->iface.continue_raised && zBridgeServer_isActive(handle, ZBridgeServer_entry__Playing_North_Sync) && handle->iface.continue_raised) { 
							{
								/* Default exit sequence for state Playing */
								{
									/* Default exit sequence for region West */
							...
							zBridgeServer_react_ZBridgeServer_entry___sync3(handle);
						} 
					}
				}
			}
...
static void zBridgeServer_react_entry__Playing_North_Wait(ZBridgeServer* handle) {
	{
		/* The reactions of state Wait. */
		if (handle->iface.playerPlays_value == handle->internal.N && handle->iface.playerPlays_raised) { 
			{
				/* Default exit sequence for state Wait */
				handle->stateConfVector[1] = ZBridgeServer_last_state;
				handle->stateConfVectorPosition = 1;
			...
			if (handle->iface.readyForPlayer_value == handle->internal.N && handle->iface.readyForPlayer_raised) { 
				{
					/* Default exit sequence for state Wait */
					handle->stateConfVector[1] = ZBridgeServer_last_state;
					handle->stateConfVectorPosition = 1;
				...
				if (handle->iface.readyForDummy_value == handle->internal.N && handle->iface.readyForDummy_raised) { 
					{
						/* Default exit sequence for state Wait */
						handle->stateConfVector[1] = ZBridgeServer_last_state;
						handle->stateConfVectorPosition = 1;
					...
					if (handle->iface.readyForDummyCards_value == handle->internal.N && handle->iface.readyForDummyCards_raised) { 
						{
							/* Default exit sequence for state Wait */
							handle->stateConfVector[1] = ZBridgeServer_last_state;
							handle->stateConfVectorPosition = 1;
...
static void zBridgeServer_react_entry__Playing_North_Sync(ZBridgeServer* handle) {
	{
		/* The reactions of state Sync. */
		if (handle->iface.continue_raised && zBridgeServer_isActive(handle, ZBridgeServer_entry__Playing_South_Sync) && handle->iface.continue_raised && zBridgeServer_isActive(handle, ZBridgeServer_entry__Playing_East_Sync) && handle->iface.continue_raised && zBridgeServer_isActive(handle, ZBridgeServer_entry__Playing_West_Sync) && handle->iface.continue_raised) { 
			{
				/* Default exit sequence for state Playing */
				{
					/* Default exit sequence for region West */
...
static void zBridgeServer_react_entry__Playing_East_Wait(ZBridgeServer* handle) {
	{
		/* The reactions of state Wait. */
		if (handle->iface.playerPlays_value == handle->internal.E && handle->iface.playerPlays_raised) { 
			{
				/* Default exit sequence for state Wait */
				handle->stateConfVector[2] = ZBridgeServer_last_state;
				handle->stateConfVectorPosition = 2;
			...
			if (handle->iface.readyForPlayer_value == handle->internal.E && handle->iface.readyForPlayer_raised) { 
				{
					/* Default exit sequence for state Wait */
					handle->stateConfVector[2] = ZBridgeServer_last_state;
					handle->stateConfVectorPosition = 2;
				...
				if (handle->iface.readyForDummy_value == handle->internal.E && handle->iface.readyForDummy_raised) { 
					{
						/* Default exit sequence for state Wait */
						handle->stateConfVector[2] = ZBridgeServer_last_state;
						handle->stateConfVectorPosition = 2;
					...
					if (handle->iface.readyForDummyCards_value == handle->internal.E && handle->iface.readyForDummyCards_raised) { 
						{
							/* Default exit sequence for state Wait */
							handle->stateConfVector[2] = ZBridgeServer_last_state;
							handle->stateConfVectorPosition = 2;
...
static void zBridgeServer_react_entry__Playing_East_Sync(ZBridgeServer* handle) {
	{
		/* The reactions of state Sync. */
		if (handle->iface.continue_raised && zBridgeServer_isActive(handle, ZBridgeServer_entry__Playing_South_Sync) && handle->iface.continue_raised && zBridgeServer_isActive(handle, ZBridgeServer_entry__Playing_North_Sync) && handle->iface.continue_raised && zBridgeServer_isActive(handle, ZBridgeServer_entry__Playing_West_Sync) && handle->iface.continue_raised) { 
			{
				/* Default exit sequence for state Playing */
				{
					/* Default exit sequence for region West */
...
static void zBridgeServer_react_entry__Playing_South_Wait(ZBridgeServer* handle) {
	{
		/* The reactions of state Wait. */
		if (handle->iface.playerPlays_value == handle->internal.S && handle->iface.playerPlays_raised) { 
			{
				/* Default exit sequence for state Wait */
				handle->stateConfVector[3] = ZBridgeServer_last_state;
				handle->stateConfVectorPosition = 3;
			...
			if (handle->iface.readyForPlayer_value == handle->internal.S && handle->iface.readyForPlayer_raised) { 
				{
					/* Default exit sequence for state Wait */
					handle->stateConfVector[3] = ZBridgeServer_last_state;
					handle->stateConfVectorPosition = 3;
				...
				if (handle->iface.readyForDummy_value == handle->internal.S && handle->iface.readyForDummy_raised) { 
					{
						/* Default exit sequence for state Wait */
						handle->stateConfVector[3] = ZBridgeServer_last_state;
						handle->stateConfVectorPosition = 3;
					...
					if (handle->iface.readyForDummyCards_value == handle->internal.S && handle->iface.readyForDummyCards_raised) { 
						{
							/* Default exit sequence for state Wait */
							handle->stateConfVector[3] = ZBridgeServer_last_state;
							handle->stateConfVectorPosition = 3;
...
static void zBridgeServer_react_entry__Playing_South_Sync(ZBridgeServer* handle) {
	{
		/* The reactions of state Sync. */
		if (handle->iface.continue_raised && zBridgeServer_isActive(handle, ZBridgeServer_entry__Playing_East_Sync) && handle->iface.continue_raised && zBridgeServer_isActive(handle, ZBridgeServer_entry__Playing_North_Sync) && handle->iface.continue_raised && zBridgeServer_isActive(handle, ZBridgeServer_entry__Playing_West_Sync) && handle->iface.continue_raised) { 
			{
				/* Default exit sequence for state Playing */
				{
					/* Default exit sequence for region West */
